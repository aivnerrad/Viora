        ...
        {posts && posts.map(post => {
          return (
            ...
            <div id="post-container">
              {post.user &&
              <div id="owner">
                {post.user.images[0].url && <img id="profile-pic" onError={(e) => e.target.src="https://www.spica-siam.com/wp-content/uploads/2017/12/user-demo.png"} src={post.user.images[0].url} alt="profile" />}
                <div id="owner-text">
